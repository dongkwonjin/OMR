...
class Config(object):
    ...
    def setting_for_path(self):
        ...
        self.dir['pre3_train'] = f'{self.dir["head_pre"]}/E03_V01_video_datalist/output_training/pickle'
        self.dir['pre3_test'] = f'{self.dir["head_pre"]}/E03_V01_video_datalist/output_validation/pickle'
    ...
    def setting_for_training(self):
        self.run_mode = 'test'  # ['train', 'test', 'eval', 'val_for_training_set']
        self.resume = True
    ...
    def setting_for_modeling(self):
        ...
        self.window_size['cross'] = 7
        self.window_size['self'] = 5
        self.window_size['corr'] = 7
