...
class Transforms(object):
    ...
    def settings(self):
        if self.cfg.mode_transform == 'basic':
            transforms = self.basic_transforms(self.cfg.height + self.cfg.crop_size, self.cfg.width)
        elif self.cfg.mode_transform == 'complex':
            transforms = self.complex_transforms(self.cfg.height + self.cfg.crop_size, self.cfg.width)
        else:
