...
class Config(object):
    ...
    def setting_for_path(self):
        ...
        # ------------------------------------------------------ #
        self.dir['pre0_train'] = f'{self.dir["head_pre"]}/E00_data_processing/output_train/pickle'
        self.dir['pre0_test'] = f'{self.dir["head_pre"]}/E00_data_processing/output_test/pickle'
        self.dir['pre2'] = f'{self.dir["head_pre"]}/E02_SVD/output_train/pickle'
        self.dir['pre3_train'] = f'{self.dir["head_pre"]}/E03_V01_video_datalist/output_train/pickle'
        self.dir['pre3_test'] = f'{self.dir["head_pre"]}/E03_V01_video_datalist/output_test/pickle'

        self.dir['model1'] = f'{os.path.dirname(os.path.dirname(self.dir["proj"]))}/ILD_cls/output'
        self.dir['model2'] = f'{os.path.dirname(os.path.dirname(self.dir["proj"]))}/ILD_reg/output'
    ...
    def setting_for_dataset_path(self):
        self.dataset_name = 'vil100'  # ['vil100']
    ...
    def setting_for_postprocessing(self):
        ...
        self.pad = dict()
        self.pad['st'] = [5, 5]  # H W
        self.pad['ed'] = [20, 25, 26]
        self.nms_thresd = 0.5
        self.prob_thresd = 0.5
        self.height_thresd = 0.5
        self.removal = dict()
        self.removal['lane_width'] = 6
    ...
    def setting_for_evaluation(self):
        ...
        self.do_eval_iou_official = True
        self.do_eval_temporal = True
