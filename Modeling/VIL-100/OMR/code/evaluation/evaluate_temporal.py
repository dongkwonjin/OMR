...
class LaneEval_Temporal(object):
    ...
    def settings(self, test_mode, iou):
        ...
        self.pred_dir = f'{self.cfg.dir["out"]}/{test_mode}/results/txt/pred_txt/'
        self.list_path = f'{self.cfg.dir["out"]}/{test_mode}/results/txt/pred_txt/datalist.txt'
    ...
    def get_video_datalist(self, datalist):
        ...
        save_pickle(f'{self.cfg.dir["out"]}/pickle/datalist_video', data=datalist_video)
    ...
    def eval_predictions(self):
        ...
        img_shape = load_pickle(f'{self.cfg.dir["out"]}/{self.test_mode}/results/shape_list')
        if self.sequential:
