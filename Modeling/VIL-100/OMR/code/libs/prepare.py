...
from libs.post_processing2 import Post_Processing as Post_Processing_for_training
...
def prepare_dataloader(cfg, dict_DB):
    ...
    trainloader = torch.utils.data.DataLoader(dataset=dataset,
                                              batch_size=cfg.batch_size['img'] * cfg.clip_length,
                                              shuffle=False,
...
def prepare_post_processing(cfg, dict_DB):
    ...
    dict_DB['post_processing'] = Post_Processing(cfg=cfg)
    dict_DB['post_processing2'] = Post_Processing_for_training(cfg=cfg)
