...
class LaneEval_CULane(object):
    ...
    def measure(self, test_mode, category):  # measure performance
        print('culane official metric evaluation start!')

        if self.cfg.sampling == False:
            res = call_culane_eval_custom(data_dir=f'{self.cfg.dir["dataset"]}/img',
                                          exp_name='',
                                          output_path=f'{self.cfg.dir["out"]}/{test_mode}/results/txt/pred_txt/',
                                          category=category)
        else:
            res = call_culane_eval_custom_sampling(data_dir=f'{self.cfg.dir["dataset"]}/img',
                                                   exp_name='',
                                                   output_path=f'{self.cfg.dir["out"]}/{test_mode}/results/txt/pred_txt/')
