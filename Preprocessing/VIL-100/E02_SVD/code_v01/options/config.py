...
class Config(object):
    ...
    def setting_for_path(self):
        ...
        self.dir['pre0'] = f'{self.dir["head_proj"]}/P00_data_processing/output_v01_{self.datalist_mode}/pickle'
        self.dir['pre1'] = f'{self.dir["head_proj"]}/P04_lane_representation_quick/output_v04_{self.datalist_mode}/pickle'
